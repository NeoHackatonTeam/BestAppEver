...
//    init(){
//        
//        CaptureFolderManager.returnModelURL(type: "Images").forEach { urlList in
//            listModel.append(FBDataModel(id: id, url: urlList.first,modelURL: CaptureFolderManager.returnModelURL(type: "Models")[id].first ?? URL(string: ""), localeModelURL: CaptureFolderManager.returnModelURL(type: "Models")[id].first, name: "Name", description: "Description"))
//            if(id < 1){
//                id += 1
//            }
//        }
////        for cpt in (0...4){
////            listModel.append(FBDataModel(id: cpt, url: CaptureFolderManager.returnModelURL(type: "Images")!,modelURL: CaptureFolderManager.returnModelURL(type: "Models")!, name: "Name", description: "Description"))
////        }
//        
//        /*listModel = [
